<?php 
    ...
    $targetpage = "manage_user_history_gif.php"; 
    $limit = 12; 
    
    $query = "SELECT COUNT(*) as num FROM $tableName 
              LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
              WHERE `status_type`='gif' AND user_id='".$user_id."'";
...
<div class="row">
  ...
  <div class="col-xs-12">
    <div class="card">
      <div class="card-header">User's Total GIF</div>
              ...
              <div class="block_wallpaper">
                ...
                <div class="wall_image_title">
                  ...
                  <ul>
                    ...
                    <li><a href="gif_status.php?edit_id=<?php echo $row['id'];?>&action=edit" target="_blank" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li>
