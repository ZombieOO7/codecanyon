<?php 
  ...
  if(isset($_GET['status']))
  {
    ...
    $targetpage = 'manage_videos.php?status'.$_GET['status'];
    ...
    if(isset($_GET['category']))
    {
      ...
      $targetpage = 'manage_videos.php?status'.$_GET['status'].'&category='.$category;
      ...
      if(isset($_GET['language']))
      {
        ...
        $targetpage = 'manage_videos.php?status'.$_GET['status'].'&category='.$category.'&language='.$language;
        ...
        if(isset($_GET['keyword']))
        {
          ...
          $targetpage = 'manage_videos.php?status'.$_GET['status'].'&category='.$category.'&language='.$language.'&keyword='.$keyword;
      ...
      else if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_videos.php?status'.$_GET['status'].'&category='.$category.'&keyword='.$keyword;
    ...
    else if(isset($_GET['language']))
    {
      ...
      $targetpage = 'manage_videos.php?status'.$_GET['status'].'&language='.$language;       
      ...
      if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_videos.php?status'.$_GET['status'].'&language='.$language.'&keyword='.$keyword;
    ...
    else if(isset($_GET['keyword']))
    {
      ...
      $targetpage = 'manage_videos.php?status'.$_GET['status'].'&keyword='.$keyword;
  ...
  else if(isset($_GET['category']))
  {
    ...
    $targetpage = 'manage_videos.php?category='.$cat_id;
    ...
    if(isset($_GET['language']))
    {
      ...
      $targetpage = 'manage_videos.php?category='.$cat_id.'&language='.$language;
      ...
      if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_videos.php?category='.$cat_id.'&language='.$language.'&keyword='.$keyword;
    ...
    else if(isset($_GET['keyword']))
    {
      ...
      $targetpage = 'manage_videos.php?category='.$cat_id.'&keyword='.$keyword;
  ...
  else if(isset($_GET['language']))
  {
      ...
      $targetpage = 'manage_videos.php?language='.$language;
      ...
      if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_videos.php?language='.$language.'&keyword='.$keyword;
  ...
  else if(isset($_GET['keyword']))
  {
      ...
      $targetpage = 'manage_videos.php?keyword='.$keyword;
      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="add_video.php?redirect=<?=$redirectUrl?>">Add Video</a> </div>
          </div>
        </div> 
        ...
        <div role="tabpanel" class="mrg-top">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="manage_videos.php">Admin Videos</a></li>
            <li role="presentation"><a href="manage_users_videos.php">Users Videos</a></li>
          </ul>
        </div>
        <div class="col-md-12">
          <div class="row">
