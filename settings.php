...
else if(isset($_POST['app_term_condition']))
{

  $data = array('app_term_condition'  =>  addslashes($_POST['term_condition']));
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom" style="padding: 0px">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#app_term_condition" aria-controls="app_term_condition" role="tab" data-toggle="tab"> Terms &amp; Conditions</a></li>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane" id="app_term_condition">   
            <div class="rows">
              <div class="col-md-12">
                <form action="" name="app_term_condition" method="post" class="form form-horizontal" enctype="multipart/form-data">
                  <div class="section">
                    <div class="section-body">
                      <?php 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <textarea name="term_condition" id="term_condition" class="form-control"><?php echo stripslashes($settings_row['app_term_condition']);?></textarea>
                          <script>CKEDITOR.replace( 'term_condition' );</script>
                        </div>
                      </div>
                      <br>
                      <div class="form-group">
                        <div class="col-md-9 col-md-offset-3">
                          <button type="submit" name="app_term_condition" class="btn btn-primary">Save</button>
                        </div>
                      </div>
                    </div>
                  </div>
