      ...
      <div class="page_title_block">
        ...
        <div role="tabpanel" class="mrg-top">
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation"><a href="manage_quotes_status.php">Admin Quotes</a></li>
            <li role="presentation" class="active"><a href="manage_user_quotes_status.php">Users Quotes</a></li>
          </ul>
        </div>
        <div class="col-md-12">
          <div class="row">
