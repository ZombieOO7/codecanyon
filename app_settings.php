                      ...
                      <div class="col-md-8 col-md-offset-3">                
                        <div id="target-content5">  
                          <div class="target-inner">
                            ...
                            <img src="assets/images/webside_admob.png" target="_blank" alt="publisher_id" />   
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">             
                            <div class="form-group" id="rewarded_video_ad_id">                              
                              <p class="field_lable">Rewarded Video Ad ID :-
                                <span>
                                  <a id="button" href="#target-content3" class="lable_tooltip">(?)</a>
                                  <div id="target-content3">  
                                    <div class="target-inner">
                                      <a href="javascript:void(0)" class="close">&times;</a>
                                      <img src="assets/images/admob_banner_id.png" alt="admob_banner_id" />   
                                    </div>
                                  </div>
                                </span>
                              </p>
                              ...
                              <p class="field_lable">Rewarded Ad After Activity Clicks :-
                                <br/>
                                <span style="color: #F00">We recommended to set more than 6 click</span>
                              </p>
                              <div class="col-md-12">                                 
                    ...
                    <div class="section-body">
                      ...
                      <div class="form-group">
                        <label class="col-md-3 control-label field_lable">New App Version Code :-
                          <span>
                            <a id="button" href="#target-content1" style="font-size: 0.9em;margin-top: 5px;font-weight: normal;" class="lable_tooltip">How to get version code</a>
                            <div id="target-content1">  
                              <div class="target-inner">
                                <a href="javascript:void(0)" class="close">&times;</a>
                                <img src="assets/images/android_version_code.png" alt="app version" />   
                              </div>
                            </div>
                          </span>
                        </label>
