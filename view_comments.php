<?php 
	...
	$row=mysqli_fetch_assoc($res);
 	...
 	$sql1="SELECT tbl_comments.*, tbl_users.`name`, tbl_users.`user_image` FROM tbl_comments, tbl_users WHERE tbl_comments.`post_id`='$id' AND tbl_comments.`type`='video' and tbl_users.`id`=tbl_comments.`user_id` ORDER BY tbl_comments.`comment_on` DESC";
	...
	<div class="app-messaging" id="collapseMessaging">
		...
		<div class="heading" style="font-size: 16px">Status Description</div>
			<ul class="group full-height">
				...
				<li class="message">
					<a href="view_reports.php?post_id=<?=$id?>">
					<div class="message">
	...
	<div class="messaging">
		<div class="heading">
			<div class="title" style="font-size: 16px">
				...
				<strong>Title</strong>&nbsp;&nbsp;<?=$row['video_title']?>
			</div>
