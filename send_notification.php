                        ...
                        <div class="col-md-9 mrg_bottom link_block">
                          <div class="form-group">
                            <label class="col-md-4 control-label">Category :-<br/>(Optional)
                              <p class="control-label-help">To directly open categories wise status when click on notification</p></label>
                              <div class="col-md-8">
                                <select name="cat_id" id="cat_id" class="select2" data-type="category">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label">Video Status :-<br/>(Optional)
                                <p class="control-label-help">To directly open single video status when click on notification</p></label>
                                <div class="col-md-8">
                                  <select name="video_id" id="video_id" class="select2" data-type="video">
                                    ...
                                    {
                                      ?>                       
                                      <option value="<?php echo $row['id'];?>"><?php echo $row['video_title'];?></option>                           
                                      <?php
                                    }
                                    mysqli_free_result($res);
                                    ?>
                              ...
                              <div class="form-group">
                                <label class="col-md-4 control-label">Image Status :-<br/>(Optional)
                                  <p class="control-label-help">To directly open single image status when click on notification</p></label>
                                  <div class="col-md-8">
                                    <select name="image_id" id="image_id" class="select2" data-type="image">
                                      ...
                                      {
                                        ?>                       
                                        <option value="<?php echo $row['id'];?>"><?php echo $row['image_title'];?></option>                           
                                        <?php
                                      }
                                      mysqli_free_result($res);
                                      ?>
                                ...
                                <div class="form-group">
                                  <label class="col-md-4 control-label">GIF Status :-<br/>(Optional)
                                    <p class="control-label-help">To directly open single gif status when click on notification</p></label>
                                    <div class="col-md-8">
                                      <select name="gif_id" id="gif_id" class="select2" data-type="gif">
                                        <option value="0">--Select GIF--</option>
                                        <?php
                                  ...
                                  <div class="form-group">
                                    <label class="col-md-4 control-label">Quote Status :-<br/>(Optional)
                                      <p class="control-label-help">To directly open single quote status when click on notification</p></label>
                                      <div class="col-md-8">
                                        <select name="quote_id" id="quote_id" class="select2" data-type="quote">
                                          ...
                                          {
                                            ?>                       
                                            <option value="<?php echo $row['id'];?>"><?php echo stripslashes($row['quote']);?></option>                           
                                            <?php
                                          }
                                          mysqli_free_result($res);
                                          ?>
