...
$sql_fav="SELECT COUNT(*) as num FROM tbl_favourite WHERE user_id='$user_id'";
$total_fav = mysqli_fetch_array(mysqli_query($mysqli,$sql_fav));
$total_fav = $total_fav['num'];
...
<div class="col-md-12 mr_bottom20">
  ...
  <div class="card mr_bottom20 mr_top10">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 mr_bot60"> <a href="manage_user_history_video.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" class="card card-banner card-skyeblue-light">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 mr_bot60"> <a href="manage_user_history_image.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" class="card card-banner card-alicerose-light">
    <div class="card-body"> <i class="icon fa fa-image fa-4x"></i>
      <div class="content">
        <div class="title">Total Images</div>
        <div class="value"><span class="sign"></span><?php echo thousandsNumberFormat($total_img);?></div>
      </div>
    </div>
  </a> 
</div>
<div class="col-lg-3 col-md-6 col-sm-6 mr_bot60"> <a href="manage_user_history_gif.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" class="card card-banner card-pink-light">
  <div class="card-body"> <i class="icon fa fa-spinner fa-4x"></i>
    <div class="content">
      <div class="title">Total GIFs</div>
      <div class="value"><span class="sign"></span><?php echo thousandsNumberFormat($total_gif);?></div>
    </div>
  </div>
</a> 
</div>
<div class="col-lg-3 col-md-6 col-sm-6 mr_bot60"> <a href="manage_user_history_quotes.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" class="card card-banner card-green-light">
  <div class="card-body"> <i class="icon fa fa-quote-right fa-4x"></i>
    <div class="content">
      <div class="title">Total Quotes</div>
      <div class="value"><span class="sign"></span><?php echo thousandsNumberFormat($total_quote);?></div>
    </div>
  </div>
</a> 
</div>
...
<div class="col-lg-3 col-md-6 col-sm-6 mr_bot60"> <a href="manage_user_favorite_status.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" class="card card-banner card-aliceblue-light">
  <div class="card-body"> <i class="icon fa fa-map-o fa-4x"></i>
    <div class="content">
      <div class="title">Favorite Statuses</div>
      <div class="value"><span class="sign"></span><?php echo thousandsNumberFormat($total_fav);?></div>
    </div>
  </div>
</a> 
</div>  
...
<div class="user_dashboard_info">
  <ul>
    <li><a href="manage_user_history.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" <?php if($currentFile=="manage_user_history.php"){ echo 'style="color: #e91e63;"'; }?>>Edit Info</a></li>
    <li><a href="manage_user_history_followers.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" <?php if($currentFile=="manage_user_history_followers.php"){ echo 'style="color: #e91e63;"'; }?>><?php echo thousandsNumberFormat($users_res_row['total_followers']);?> Followers</a></li>
    <li><a href="manage_user_history_followings.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" <?php if($currentFile=="manage_user_history_followings.php"){ echo 'style="color: #e91e63;"'; }?>><?php echo thousandsNumberFormat($users_res_row['total_following']);?> Following</a></li>        
    <li><a href="manage_user_history_withdrawal.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" <?php if($currentFile=="manage_user_history_withdrawal.php"){ echo 'style="color: #e91e63;"'; }?>>Withdrawal</a></li>
    <li><a href="manage_user_history_total_points.php?user_id=<?php echo $users_res_row['id'];?>&redirect=<?=$_GET['redirect']?>" <?php if($currentFile=="manage_user_history_total_points.php"){ echo 'style="color: #e91e63;"'; }?>>All Points History</a></li>
  </ul>
</div>
</div>
</div>