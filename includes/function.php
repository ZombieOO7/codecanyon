...
function checkSignSalt($data_info){
  ...
  if($data_arr['package_name']==PACKAGE_NAME){
    ...
    $set['status']=-1;
    $set['message']="You are using Package name is already in use, for more information contact us: info@viaviweb.com or viaviwebtech@gmail.com";   
...
{  
  ...
  if ($server_output == "success") { echo "done"; } else { echo "fail!";}     
}
