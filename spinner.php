      ...
      <div class="col-xs-12">
        <div class="card mrg_bottom">
          ...
          <div class="col-md-12 mrg-top">
            <form class="form-inline" action="" method="post">
              <div class="form-group col-md-3">
                <div class="row toggle_btn" style="margin-top: 0px;margin-left:0;top: 9px">
                  <p style="float:left;font-weight: 600">Enable/Disable in App:&nbsp;&nbsp;</p>
            ...
            <div class="col-md-12">
              <br/>
              <b><i class="fa fa-hand-o-right"></i>Notes for Ads. on every spin or not</b>   
              <p style="color:red;padding-top:7px">
                If Rewarded Ads is enable in Ads Settings in Setting tab then ads is enable in the spin
              </p>
            </div>
