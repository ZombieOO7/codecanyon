<?php 
    ...
    $targetpage = 'manage_gif_status.php';
    $limit = 12;
    ...
    if(isset($_GET['status']))
    {
      ...
      $targetpage = 'manage_gif_status.php?status='.$_GET['status'];
      ...
      if(isset($_GET['category']))
      {
        ...
        $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&category='.$category;
        ...
        if(isset($_GET['language']))
        {
          ...
          $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&category='.$category.'&language='.$language;
          ...
          if(isset($_GET['keyword']))
          {
            ...
            $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&category='.$category.'&language='.$language.'&keyword='.$keyword;
          }
        } 
        else if(isset($_GET['keyword']))
        {
          ...
          $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&category='.$category.'&keyword='.$keyword;
      ...
      else if(isset($_GET['language']))
      {
        ...
        $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&language='.$language;
        ...
        if(isset($_GET['keyword']))
        {
          ...
          $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&language='.$language.'&keyword='.$keyword;
        }
      } 
      else if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_gif_status.php?status='.$_GET['status'].'&keyword='.$keyword;
      }
    ...
    else if(isset($_GET['category']))
    {
      ...
      $targetpage = 'manage_gif_status.php?category='.$category;
      ...
      if(isset($_GET['language']))
      {
        ...
        $targetpage = 'manage_gif_status.php?category='.$category.'&language='.$language;
        ...
        if(isset($_GET['keyword']))
        {
          ...
          $targetpage = 'manage_gif_status.php?category='.$category.'&language='.$language.'&keyword='.$keyword;
        }
      } 
      else if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_gif_status.php?category='.$category.'&keyword='.$keyword;
      }
    }
    else if(isset($_GET['language']))
    {
      ...
      $targetpage = 'manage_gif_status.php?language='.$language;
      ...
      if(isset($_GET['keyword']))
      {
        ...
        $targetpage = 'manage_gif_status.php?language='.$language.'&keyword='.$keyword;
    ...
    else if(isset($_GET['keyword']))
    {
      ...
      $targetpage = 'manage_gif_status.php?keyword='.$keyword;
    }
    else
    {
      $query="SELECT tbl_category.`category_name`,tbl_img_status.* FROM tbl_img_status
      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="gif_status.php?action=add&redirect=<?=$redirectUrl?>">Add New</a> </div>
          </div>
        </div>
        ...
        <div role="tabpanel" class="mrg-top">
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="manage_gif_status.php">Admin GIF Status</a></li>
            <li role="presentation"><a href="manage_user_gif_status.php">Users GIF Status</a></li>
          </ul>
        </div>
        <div class="col-md-12">
          <div class="row">
