<?php 
    ...
    if(isset($_POST['btn_submit']) AND $action=='add')
    {
        ...
        list($file_width, $file_height) = getimagesize($file_path_img.$tpath1);
  ...
  <div class="col-md-12">
    <?php
      if(isset($_GET['redirect'])){
        ...
        echo '<a href="manage_gif_status.php" class="btn_back"><h4 class="pull-left" style="font-size: 20px;color: #e91e63"><i class="fa fa-arrow-left"></i> Back</h4></a>';
      }
    ?>
    <div class="card">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="fileupload_block">
                    ...
                    <?php }else{ ?>
                    <div id="uploadPreviewImg">
                      <div class="fileupload_img"><img type="image" src="assets/images/landscape.jpg" style="width: 150px;height: auto;" alt="image alt" /></div>
                    </div>
                    <?php } ?>
  ...
  function fileValidation(){
    ...
    if(!allowedExtensions.exec(filePath)){
        ...
        if(filePath!=''){
          ...
          $("#uploadPreviewImg").find("img").css({width:"150px", height: "auto"});
